...
def command_launch_remote_debugger(_connection=None):
    ...
    eventual_bridged_ui = gateway.request_bridged_ui(None, 'http://localhost:3000', _bridged_ui_uuid, 'PlumbBuddy Proxy', 'You typed the command in the game console to get me to make this request.', 'Remote Debugger')
